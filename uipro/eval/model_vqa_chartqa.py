...
def eval_model(args):
    ...
    # questions = json.loads(args.question_file)
    ...
    json.dump(outputs, open(args.answers_file, 'w'), ensure_ascii=False)
    ans_file.close()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image-folder", type=str, default="playground/data/eval/ChartQA/ChartQA_Dataset/test/png")
    parser.add_argument("--question-file", type=str, default="playground/data/eval/ChartQA/ChartQA_Dataset/test/test.json")
