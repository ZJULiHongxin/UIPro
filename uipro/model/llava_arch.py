...
from uipro.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, GEMMA_PATCH_POS

from uipro.mm_utils import get_anyres_image_grid_shape, select_best_resolution_uhd
from uipro.model.multimodal_resampler.sampler import MultiCompressor
...
class LlavaMetaModel:
    ...
    def initialize_vision_modules(self, model_args, fsdp=None):
        ...
        if pretrain_mm_mlp_adapter is not None:
            print(f"Load pretrained mm projector from {pretrain_mm_mlp_adapter}")
