...
from utils.openai_utils.misc import extract_thought_components, parse_atlas_action
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--scale', type=int, default=1, help="Coordinate scale (e.g., 1 for ShowUI, 1000 for others).")
